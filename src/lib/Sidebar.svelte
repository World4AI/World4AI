...
<aside
  class="bg-gray-100 select-none border-r sticky top-[53px] left-0 max-h-[92vh] overflow-y-auto z-40"
>
  <nav class="p-4">
    {#each data as folder}
      <h6 class="font-bold text-sm">{folder.name}</h6>
      <ul class="text-sm mb-4">
        {#each folder.links as section}
          <li>
            <a
