...
<Container>
  <p>
    ...
    function and are we guaranteed to find such weights?
  </p>
  ...
  <p>
    What does convergence mean for the prediction problem? For tabular methods
    we aspire to find the true value function of a policy <Latex>\pi</Latex>.
  ...
  <p>
    What does convergence mean for control? For tabular methods that means to
  ...
  <p>
    ...
    divergence. We will learn more about those in the next chapters.
  </p>
  <div class="separator" />
</Container>
