...
<Container>
  <p>
    ...
    algorithms can be classified based on the components the agent has.
  </p>
  <div class="separator" />
  ...
  <p>
    ...
    value function are called <strong>value based methods</strong>. If on the
    other hand the agent derives the policy directly without using value
    functions the methods are called <strong>policy based methods</strong>. Most
  ...
  <p>
    ...
    is called <strong>learning</strong>. If the agent on the other hand utilizes
  ...
  <p>
    ...
    <strong>Continuing</strong> tasks are tasks that do not have a natural ending
    and may theoretically go on forever.
  </p>
  <div class="separator" />
</Container>
