...
<Container>
  ...
  <p>
    ...
    value of the error, <Latex>| \delta |</Latex>, is going to be used.
  </p>
  <p>
  ...
  <p>
    Ranked-based priorization: <Latex
      >{String.raw`p_i = \frac{1}{rank(i)}`}</Latex
  ...
  <p>
    ...
    a uniform distribution. Higher numbers of <Latex>\alpha</Latex> increase the
    to higher importance of priorities.
  </p>
  ...
  <p>
    If we are not careful and keep using the prioritized experience replay
  ...
  <p>
    ...
    do not need any adjustments. The <Latex>\beta</Latex> factor is used to control
    ...
    value over time to make full corrections.
  </p>
</Container>
