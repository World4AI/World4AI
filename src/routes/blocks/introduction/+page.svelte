  ...
  <Container>
    ...
    <svg version="1.1" viewBox="0 0 350 400" xmlns="http://www.w3.org/2000/svg">
     <g fill="none" stroke="#000" stroke-width="1.0175">
      <g id="left">
       <rect id="left-box" x="7.051" y="6.7799" width="60.322" height="386.44" ry="0"/>
      ...
      <g id="middle">
       <rect id="middle-box" x="144.59" y="52.999" width="60.479" height="294" ry="0"/>
      ...
      <g id="right">
       <rect id="right-box" x="281.26" y="138.79" width="60.86" height="122.42" ry="0"/>
