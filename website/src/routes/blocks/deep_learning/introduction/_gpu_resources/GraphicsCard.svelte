<svg version="1.1" viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="lines" stroke="#fff" stroke-width="1px">
  ...
  <g id="fan">
    <circle
      ...
      stroke-width="3"
    />
    <g id="rotors" fill="none" stroke="#fff">
    ...
    <circle cx="167.38" cy="149.18" r="6.7554" fill="#fff" />
  </g>
  ...
  <g id="top-lines" fill="none" stroke="#fff" stroke-width="1px">
    <path d="m300 60v40" />
    <path d="m310 60v40" />
    <path d="m320 60v40" />
    <path d="m330 60v40" />
