...
<Container>
  ...
  <p>This section is going to be highly practical and we will mostly avoid theory. We will start by discussing how we can measure performance and memory consumption. The recepies for improving performance will follow afterwards.</p>
  <div class="separator" />
</Container>
