...
<p>Any operations that are even remotely related to mathematics require the use of numeric data types. In machine learning each picture, sound, text and so on has to be transfered into a numeric data type, before we can apply any algorithms to the data. Python provides different types of operators that can be utilized to conduct mathematical calculations.</p>
<div class="separator"></div>
<h2>Operators</h2>
...
<p>Assignment operators assign values of the right operand to the left operand.</p>
<Code code={`a = 10
b = a
print(b)`
} />
