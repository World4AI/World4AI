...
<Container>
  <p>
    ...
    function of one policy is always larger than the value function of the
    second policy we can state that the first policy is strictly better than the
    second policy:
    <Highlight
      ><Latex>{String.raw`v_{\pi} > v_{\pi'} \Rightarrow \pi > \pi'`}</Latex
      ></Highlight
    >. It seems therefore logical that if our goal is to find the optimal
    policy, our first priority should be to find a way to compute value
    functions for a given policy. To put it differently: we have to find the
...
`}</Latex
  ...
  <p>
    To simplify notation we average the reward function <Latex>R(a,s)</Latex> and
    the transition function <Latex>P(s' \mid s, a)</Latex> over the possible actions
    from the policy <Latex>\pi</Latex> and create the following definitions.
  </p>
...
\end{aligned}
  ...
  >
  <p>
    The above solution is mathematically correct, but challenging in many
    relevant aspects. First, the inverse of the matrix introduces computational
    complexity of the magnitute <Latex>O(N^3)</Latex>. The cubic growth makes
    any practical algorithm with a sufficient large state space infeasible.
    Second, the above system of equations allows us to find the value function
    for a given policy <Latex>\pi</Latex>, but it not clear how we could find
    the optimal policy and value function for a given Markov decision process.
    Dynamic programming alleviates both of the above mentioned problems.
  </p>
  <div class="separator" />
  <h2>Dynamic Programming Solutions</h2>
  <p>
    Just as the Bellman equations, dynamic programming was developed by Richard
    Bellman in the 1950's. The idea of dynamic programming is to divide a
    problem into a collection of subproblems that can be solved recursively.
  </p>
  <p>
    ...
    found. The numbers in the Fibonacci series are always the sum of the
    previous two numbers in the series and the very first numbers are 0 and 1.
    We define the function that returns the n'th number in the series as <Latex
      >F(n)</Latex
...
\end{aligned}
  ...
  <p>
    ...
    value of <Latex>F(n-2)</Latex> once, store the value in memory and each time
    we need to have access to that value we access the stored value instead of recalculating.
  </p>
  <svg version="1.1" viewBox="0 0 1300 550" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="text" fill="black" font-family="sans-serif" font-size="40px">
      <text
        ...
        xml:space="preserve"
        ><tspan x="739.92188" y="48.289062">F(5)</tspan></text
      >
      <text
        x="399.92188"
        y="165.78905"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="399.92188" y="165.78905">F(4)</tspan></text
      >
      <text
        x="239.92188"
        y="283.28903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="239.92188" y="283.28903">F(3)</tspan></text
      >
      <text
        x="123.92184"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="123.92184" y="400.78903">F(2)</tspan></text
      >
      <text
        x="1049.9219"
        y="165.78905"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="1049.9219" y="165.78905">F(3)</tspan></text
      >
      <text
        x="579.92188"
        y="283.28903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="579.92188" y="283.28903">F(2)</tspan></text
      >
      <text
        x="953.25519"
        y="283.28903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="953.25519" y="283.28903">F(2)</tspan></text
      >
      <text
        x="1179.9219"
        y="283.28903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="1179.9219" y="283.28903">F(1)</tspan></text
      >
      <text
        x="863.92188"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="863.92188" y="400.78903">F(1)</tspan></text
      >
      <text
        x="1039.9219"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="1039.9219" y="400.78903">F(0)</tspan></text
      >
      <text
        x="503.92188"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="503.92188" y="400.78903">F(1)</tspan></text
      >
      <text
        x="679.92188"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="679.92188" y="400.78903">F(0)</tspan></text
      >
      <text
        x="299.92188"
        y="400.78903"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="299.92188" y="400.78903">F(1)</tspan></text
      >
      <text
        x="39.921875"
        y="518.28906"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="39.921875" y="518.28906">F(1)</tspan></text
      >
      <text
        x="199.92188"
        y="518.28906"
        style="line-height:1.25"
        xml:space="preserve"
        ><tspan x="199.92188" y="518.28906">F(0)</tspan></text
      >
    </g>
  ...
  <p>
    ...
    numbers indicate function calls that need to actually calculate the sum of
    two numbers in the sequence. The blue numbers indicate function calls that
    look up the values in memory and therefore do not require additional
    computations. As the number in the sequence, <Latex>n</Latex>, becomes
    larger the computation savings become larger and larger.
  </p>
  <p>
...
`}</Latex
  ...
  <p>
    The subproblems in Bellman equations can be infinitely more comples than
    those in the Fibonacci sequence. The reason for that is the complexity of
    interconnections between the subproblems. In the drawing for example the
    value of state 0 depends on the value of state 1 and the value of state 1
    depends on the value of state 0. At the same time value of state 0 depends
    on itself.
  </p>
  <p>
    The dynamic programming algorithms that we are going to cover in this
    section are not those that are commonly used to solve reinforcement learning
    tasks. In fact there is no learning involved at all. Dynamic programming
    (DP) requires the full knowledge of the model of the environment and
    calculates the optimal value function and optimal policy through the
    knowledge of that model. The interaction between the agent and the
    environment is not necessary. Nevertheless dynamic programming is the usual
    introduction to the solution of MDPs, because the knowledge gained by
    studying DP algorithms is transferable to reinforcement learning.
  </p>
  <div class="separator" />
</Container>
