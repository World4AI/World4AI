...
<Container>
  <p>
    ...
    word until the dog sits down. When it does, give it a treat. If you keep
    doing that the dog should learn sooner or later to sit down when you give
    the command. The process would most likely take time and require a lot of
  ...
  <p>
    We could also think about mice in a maze that get food once they arrive at
    the goal. The amount of food could depend on the time a mouse needs to
    complete the maze. If the mouse takes the blue path, the route is relatively
    straight forward and the mouse ends up at the goal without any delays. The
    red path on the other hand leads to a dead end, which forces the mouse to
    retrace the steps. Over time the mouse will learn the shourtest route which
