...
<Container>
  <p class="info">
    "We first show that the recent DQN algorithm, which combines Q-learning with
  ...
  <p>
    The DQN algorithm suffers from a similar maximization bias that is present
...
r + \gamma \max_{a'} Q(s', a', \mathbf{w}^-)
  ...
  <p>
    ...
    will allow us to to separate action selection and action value calculation.
  </p>
  <Latex
    >{String.raw`
