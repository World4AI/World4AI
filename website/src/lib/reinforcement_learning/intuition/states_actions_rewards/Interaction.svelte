  ...
  <svg version="1.1" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <g stroke-width="1.2" stroke="var(--text-color)" fill="none">
      ...
      <g stroke-dashoffset={offset}>
        <path
          id="env-agent-path"
          d="m80 154v-84h340v74"
          fill="none"
          marker-end="url(#TriangleOutL)"
          marker-mid="url(#marker4840)"
          marker-start="url(#EmptyDiamondL)"
          stroke="var(--text-color)"
      ...
      <g stroke-dashoffset={offset}>
        <path
          id="agent-env-path"
          d="m420 348v70h-340v-100"
          fill="none"
          marker-end="url(#marker5204)"
          marker-mid="url(#marker5194)"
          marker-start="url(#marker5184)"
          stroke="var(--text-color)"
          stroke-dasharray="5, 25"
        />
      </g>
      <g font-family="sans-serif" fill="var(--text-color)">
        ...
        <text
          ...
          ><tspan
            ...
            stroke-width=".47167"
            style="font-variant-caps:normal;font-variant-east-asian:normal;font-variant-ligatures:normal;font-variant-numeric:normal"
            >State to Action</tspan
          ></text
        >
        <text
          id="generate-newstate-text"
          transform="rotate(-90)"
          x="-308.66428"
          y="165.19115"
          font-size="18.867px"
      ...
      <g stroke-dashoffset={offset}>
        <g fill="none" stroke="var(--text-color)">
          <path
            id="generate-newstate"
            d="m120 180v-30h80v200h-80v-40"
            marker-end="url(#marker2510)"
            marker-start="url(#marker2500)"
            stroke-dasharray="4,8"
          />
          <path
            id="generate-action"
            d="m394 170v-30h-90v210h80v-40"
            marker-end="url(#marker3359)"
            marker-start="url(#marker3172)"
            stroke-dasharray="4, 8"
          />
          <path
            id="learn"
            d="m410 160v-40h-140v250h130v-50"
