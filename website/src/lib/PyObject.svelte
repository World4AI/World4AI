...
<svg {width} {height} viewBox="0 0 {width} {height}">
  <g transform="translate(5, 5)">
    <g
      fill="none"
      stroke-width="2"
      stroke={garbageCollection ? "var(--main-color-1)" : "var(--text-color)"}
    >
      <rect x="0" y="0" width={boxWidth * 2 + boxMargin} height={boxHeight} />
      <text
        stroke="none"
        fill="var(--text-color)"
        x={boxWidth + boxMargin}
    ...
    {#if variable}
      <rect
        ...
        stroke-width="2"
        x="400"
        y={height / 2 - boxHeight + boxMargin}
        width={boxWidth}
        height={boxHeight}
      />
      <text
      ...
      {#if !garbageCollection}
        <path
          stroke="var(--text-color)"
          stroke-width="2"
          d="M {400} {height / 2 - boxHeight / 2 + boxMargin} h -90"
        />
      {:else if garbageCollection}
        <path
          stroke="var(--text-color)"
          stroke-width="2"
          d="M {400 + boxWidth} {height / 2 - boxHeight / 2 + boxMargin} h +90"
        />
      {/if}
    {/if}
    {#if variable2}
      <rect
        ...
        stroke-width="2"
        x="400"
        y={height / 2 - boxHeight + boxMargin + 50}
        width={boxWidth}
        height={boxHeight}
      />
      <text
      ...
      <path
        stroke="var(--text-color)"
        stroke-width="2"
        d="M {400} {height / 2 - boxHeight / 2 + boxMargin + 50} h -90"
      />
    {/if}
  </g>
</svg>
