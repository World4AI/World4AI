...
<style scoped>
    ...
    .info {
        box-shadow: -5px 5px 0px 0px var(--main-color-1), 5px -5px 0px 0px var(--main-color-1);
        padding: 10px;
    }
