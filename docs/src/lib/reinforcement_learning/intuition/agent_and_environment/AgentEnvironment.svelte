...
<svg width="500" height="120" version="1.1" viewBox="0 0 500 120" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" stroke="var(--text-color)">
     <g id="environment">
      <rect x=".59406" y=".59406" width="118.81" height="118.81" opacity=".999" stroke-linejoin="round" stroke-width="1.1881"/>
      <rect x="10.495" y="10.495" width="99.01" height="99.01" opacity=".999" stroke-linejoin="round" stroke-width="1"/>
      <g stroke-width="1">
     ...
     <g id="agent">
      <g>
       <rect x="409.54" y="28.153" width="63.797" height="63.797" ry="0" stroke-width="1"/>
       <rect x="415.92" y="34.533" width="51.036" height="51.036" ry="0" stroke-width="1"/>
       <circle cx="441.44" cy="60.05" r="9.6947" fill-rule="evenodd" stroke-linejoin="round" stroke-width="1"/>
      </g>
      <g stroke-width="1">
     ...
     <g id="direction">
      <path d="m130 10h240" stroke-dasharray="8,2,1,2" stroke-dashoffset={offsetTop}/>
      <path d="m370 110h-240" stroke-dasharray="8,2,1,2" stroke-dashoffset={offsetBottom}/>
     </g>
    </g>
   </svg>